  ...
  return (
    <Card className="border-destructive">
      <CardHeader>
        ...
        <CardDescription>
          Permanently remove your business and all of its contents from the PayGrid
              ...
              <AlertDialogDescription asChild>
                <div>
                  <p>
                    ...
                    your business and remove your data from our servers.
                  </p>
            ...
            <AlertDialogFooter>
              ...
              <AlertDialogAction
                onClick={() => {
                  ...
                  deleteBusinessMutation.mutate({ id: user.businessId });
                }}
                disabled={value !== "DELETE" || !user?.businessId}
              >
