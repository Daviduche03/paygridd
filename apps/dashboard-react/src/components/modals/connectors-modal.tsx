      ...
      <ScrollArea className="flex-1 min-h-0" hideScrollbar>
        <div className="space-y-5">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            Connect {connector.name} to PayGrid to let the AI assistant access and interact with your {connector.name} data.
          </p>
...
function ConnectorsContent({
  ...
  const { data: catalog } = useStableQuery(
        ...
        <div className="p-4 h-[500px] flex flex-col">
          {!isDetail && (
            <DialogHeader className="mb-4 shrink-0">
              ...
              <DialogDescription>
                Connect your apps and services to PayGrid. Your AI assistant can
