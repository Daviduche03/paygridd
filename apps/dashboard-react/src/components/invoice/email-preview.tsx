...
export function EmailPreview() {
  ...
  // Defaults are imported from email/defaults so they stay in sync
  // with the actual email template the customer receives.
  const displaySubject = emailSubject || defaultEmailSubject(businessName);
  const displayHeading = emailHeading || defaultEmailHeading(businessName);
  const displayBody = emailBody || defaultEmailBody(businessName);
          ...
          <div className="p-6 pb-4 shrink-0">
            ...
            <div className="flex items-start gap-3">
              <div className="size-10 rounded-full bg-white dark:bg-[#1a1a1a] border border-border flex items-center justify-center flex-shrink-0">
                <img
                  src="https://paygrid.xyz/email/logo.png"
                  alt="PayGrid"
